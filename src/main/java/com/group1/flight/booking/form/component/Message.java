...
public class Message extends JPanel {
    ...
    public void showMessage(MessageType messageType, String message) {
        ...
        if (messageType == MessageType.SUCCESS) {
            lbMessage.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/com/group1/flight/booking/view/icon/success.png"))));
        } else {
            lbMessage.setIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/com/group1/flight/booking/view/icon/error.png"))));
        }
    }
