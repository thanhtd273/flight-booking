...
public class OTPVerifierPanel extends JPanel {

    private static final Logger logger = LoggerFactory.getLogger(OTPVerifierPanel.class);
    ...
    public OTPVerifierPanel(JPanel mainPanel, CardLayout cardLayout, UserService userService) {
